function global_kin_mat = global_kinematic_matrix_modified(base_sensor_base_frame_position_base_frame, ...
                     statevar, base_rw_joint_sensor_frame_position_sensor_frame)
    
    % Load robot structural and dynamic parameter data
    [num_links, ~, joint_twist_angle, link_length_DH, ...
    ...
    for curr_arm_initial_link_index = arm_initial_link_index
        ...
        if curr_arm_initial_link_index == arm_terminal_link_index(end)
            base_arm_joint_sensor_frame_position_sensor_frame(:,  curr_arm_index) = ...
